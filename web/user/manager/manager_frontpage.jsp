...
<html lang="en">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="member_booking.jsp">Report</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="member_guest.jsp">User Management</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <center><h3 class="offcanvas-title">Manager page</h3></center>
    <hr>
        ...
        <tr>
            ...
            <td width="30%">
                <table border="1" width="90%">
                    ...
                    <tr>
                        <td align="center"><a class="btn btn-primary" href="#">Report</a></td>
                    </tr>
                </table>
            </td>
            ...
            <td width="30%">
                <table border="1" width="90%">
                    ...
                    <tr>
                        <td align="center"><a class="btn btn-primary" href="#">User Management</a></td>
                    </tr>
                </table>
            </td>
            <td width="20%">
